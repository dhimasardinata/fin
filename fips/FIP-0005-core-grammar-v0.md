...
- implementation:
  ...
  - tests/conformance/fixtures/main_exit_while_countdown.fn
  - tests/conformance/fixtures/main_exit_helper_while_return.fn
  ...
  - tests/conformance/fixtures/invalid_while_missing_body.fn
  - tests/conformance/fixtures/invalid_while_non_u8_condition.fn
  ...
  - tests/conformance/fixtures/invalid_uppercase_bool_literal.fn
  - tests/conformance/fixtures/invalid_uppercase_statement_keyword.fn
  - tests/conformance/fixtures/invalid_uppercase_else_keyword.fn
  - tests/conformance/fixtures/invalid_uppercase_while_keyword.fn
  - tests/conformance/fixtures/invalid_uppercase_result_constructor.fn
  - tests/conformance/fixtures/invalid_uppercase_type_annotation.fn
...
10. `while (<expr>) { <stmt>* }` (stage0 statement-form loop block; condition must be `u8`; selected iterations run with block scope and a bootstrap iteration limit)
11. `drop(<ident>)`
12. `exit(<expr>)` and `return <expr>` / `return(<expr>)` (terminal statement forms)
