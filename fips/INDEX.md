...
| FIP-0005 | Core Grammar v0 | Scheduled | `fin://fip/FIP-0005` |
...
| FIP-0009 | Linux ABI and Syscall Contract | Scheduled | `fin://fip/FIP-0009` |
...
| FIP-0015 | Unified fin CLI Contract | InProgress | `fin://fip/FIP-0015` |
| FIP-0016 | Package Manifest and Lockfile | Draft | `fin://fip/FIP-0016` |
...
| FIP-0020 | CI Gate: External Toolchain Prohibited | Scheduled | `fin://fip/FIP-0020` |
