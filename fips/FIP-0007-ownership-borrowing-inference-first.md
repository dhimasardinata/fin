...
25. Nested wrapper composition preserves moved-result constraints; `ok(try(move(<result-ident>)))` consumes moved inputs consistently and still rejects hidden-control-flow err-state paths.
