...
14. Conformance now also asserts deterministic diagnostics for result-typed lifecycle misuse on immutable and consumed bindings (use-after-drop/move, assign-after-drop/move-immutable, and invalid drop/move transitions).
