...
20. Assignment/move/drop operations on non-reference targets are rejected while active reference bindings still borrow the target; dropping/moving the reference binding itself releases that restriction.
