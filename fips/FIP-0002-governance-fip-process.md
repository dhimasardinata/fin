...
6. `ci/verify_fip_metadata.ps1` verifies FIP filename/header/metadata consistency, allowed lifecycle statuses, `requires` references, implementation-path existence, required sections, index synchronization, status-label coverage, and CI/doctor wiring.
