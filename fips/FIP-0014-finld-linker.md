...
10. Reject non-entry relocation materialization, relocation offsets outside stage0 target code bounds, and relocation offsets that are not supported stage0 patch sites for the selected target (Linux: 6, Windows: 1).
