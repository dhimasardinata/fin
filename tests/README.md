...
- `tests/reproducibility/verify_manifest_policy_gate.ps1`: manifest policy gate self-check coverage for workspace identity, version, canonical seed-hash syntax, case-sensitive target schema, dependency entry syntax, canonical booleans, and policy switches, with PID-scoped temp workspace hygiene.
