...
- `verify_finobj_roundtrip.ps1`, `verify_finobj_link.ps1`, and `verify_stage0_reproducibility.ps1` use PID-scoped temp roots under `artifacts/tmp` and prune stale temp dirs from prior runs.
