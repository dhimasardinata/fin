...
- `tests/conformance/verify_stdlib_contract.ps1`: stage0 FIP-0017 stdlib plan gate, validating required lean module entries, FIP implementation linkage, and no-libc policy wording.
