...
- `tests/reproducibility/verify_seed_hash_policy_gate.ps1`: seed hash policy self-check coverage for manifest/SHA256SUMS consistency, release-required hash enforcement, safe artifact paths, lowercase hash syntax, supported artifact format, seed identity/version and policy booleans, real artifact hash verification, and UNSET/artifact conflict rejection.
