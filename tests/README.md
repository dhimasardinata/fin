...
- `tests/reproducibility/verify_manifest_policy_gate.ps1`: manifest policy gate self-check coverage for workspace identity, version, seed-hash syntax, target schema, and policy switches, with PID-scoped temp workspace hygiene.
