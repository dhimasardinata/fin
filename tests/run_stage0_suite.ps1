...
$verifyOwnershipBorrowContract = Join-Path $repoRoot "tests/reproducibility/verify_ownership_borrow_contract.ps1"
...
& $fin build --src tests/conformance/fixtures/main_exit_let_unwrap_binding_ok.fn --out artifacts/test-exit141
& $fin build --src tests/conformance/fixtures/main_exit_let_unwrap_binding_move_ok.fn --out artifacts/test-exit142
& $fin build --src tests/conformance/fixtures/main_exit_let_unwrap_binding_arithmetic.fn --out artifacts/test-exit143
& $fin build --src tests/conformance/fixtures/main_exit_unwrap_assignment_ok.fn --out artifacts/test-exit144
& $fin build --src tests/conformance/fixtures/main_exit_unwrap_assignment_move_ok.fn --out artifacts/test-exit145
& $fin build --src tests/conformance/fixtures/main_exit_unwrap_assignment_arithmetic.fn --out artifacts/test-exit146
& $fin build --src tests/conformance/fixtures/main_exit_var_unwrap_binding_ok.fn --out artifacts/test-exit147
& $fin build --src tests/conformance/fixtures/main_exit_var_unwrap_binding_move_ok.fn --out artifacts/test-exit148
& $fin build --src tests/conformance/fixtures/main_exit_var_unwrap_binding_arithmetic.fn --out artifacts/test-exit149
& $fin build --src tests/conformance/fixtures/main_exit_borrow_deref.fn --out artifacts/test-exit150
& $fin build --src tests/conformance/fixtures/main_exit_borrow_typed_u8.fn --out artifacts/test-exit151
& $fin build --src tests/conformance/fixtures/main_exit_borrow_result_try.fn --out artifacts/test-exit152
& $fin build --src tests/conformance/fixtures/main_exit_borrow_reflects_reassign.fn --out artifacts/test-exit153
& $fin build --src tests/conformance/fixtures/main_exit_borrow_drop_ref_then_move.fn --out artifacts/test-exit154
& $fin build --src tests/conformance/fixtures/main_exit_borrow_drop_ref_then_assign.fn --out artifacts/test-exit155
& $fin build --src tests/conformance/fixtures/main_exit_assign_after_rhs_releases_borrow.fn --out artifacts/test-exit156
...
if (-not $SkipRun) {
    ...
    if (-not $Quick) {
        ...
        & $fin run --no-build --out artifacts/test-exit141 --expect-exit 141
        & $fin run --no-build --out artifacts/test-exit142 --expect-exit 142
        & $fin run --no-build --out artifacts/test-exit143 --expect-exit 143
        & $fin run --no-build --out artifacts/test-exit144 --expect-exit 144
        & $fin run --no-build --out artifacts/test-exit145 --expect-exit 145
        & $fin run --no-build --out artifacts/test-exit146 --expect-exit 146
        & $fin run --no-build --out artifacts/test-exit147 --expect-exit 147
        & $fin run --no-build --out artifacts/test-exit148 --expect-exit 148
        & $fin run --no-build --out artifacts/test-exit149 --expect-exit 149
        & $fin run --no-build --out artifacts/test-exit150 --expect-exit 150
        & $fin run --no-build --out artifacts/test-exit151 --expect-exit 151
        & $fin run --no-build --out artifacts/test-exit152 --expect-exit 152
        & $fin run --no-build --out artifacts/test-exit153 --expect-exit 153
        & $fin run --no-build --out artifacts/test-exit154 --expect-exit 154
        & $fin run --no-build --out artifacts/test-exit155 --expect-exit 155
        & $fin run --no-build --out artifacts/test-exit156 --expect-exit 156
