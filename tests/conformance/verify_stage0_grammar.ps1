...
Assert-ParseFailContains -RelativePath "tests/conformance/fixtures/invalid_try_missing_expression.fn" -ExpectedMessagePart "unsupported expression 'try()'"
Assert-ParseFailContains -RelativePath "tests/conformance/fixtures/invalid_ok_missing_expression.fn" -ExpectedMessagePart "unsupported expression 'ok()'"
Assert-ParseFailContains -RelativePath "tests/conformance/fixtures/invalid_err_missing_expression.fn" -ExpectedMessagePart "unsupported expression 'err()'"
