...
- `verify_result_try_contract.ps1`: validates the checked FIP-0008 stage0 `Result<u8,u8>`/`try` contract across FIP status, parser hooks, conformance diagnostics, runtime fixture coverage, and aggregated suite wiring.
