...
- `verify_seed_hash_policy_gate.ps1`: validates seed manifest/SHA256SUMS consistency, `UNSET` handling, `-RequireSet` rejection, concrete artifact hash parity, and mismatch failures for FIP-0003.
