...
Shared helper: `tests/common/finobj_output_helpers.ps1` for capturing/parsing `finobj_written=...` output and shared finobj temp-artifact cleanup assertions in finobj pipeline integration checks.
