...
Shared helper: `tests/common/finobj_output_helpers.ps1` for capturing/parsing `finobj_written=...` output and shared finobj temp-artifact cleanup + SHA256 parity assertions in finobj pipeline integration checks.
