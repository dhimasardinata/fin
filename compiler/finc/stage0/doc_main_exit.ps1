...
- Current grammar subset: fn main() [-> u8] { let/var/assign/exit } with u8 literals, identifier expressions, stage0 bootstrap `try(<expr>)`, and optional `: u8` binding annotations.
"@
